"""
Django settings for cleaning_firm project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-2f^@()$(2e!^52716gk-rg2xz0keyvacfyihol1vxd^h1r2uk7')
...
ROOT_URLCONF = 'cleaning_firm.urls'
...
WSGI_APPLICATION = 'cleaning_firm.wsgi.application'
